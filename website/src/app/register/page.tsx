        ...
        {!result ? (
          <div className="rounded-2xl bg-white p-8 shadow-2xl">
            ...
            <fieldset className="mt-6">
              ...
              <div className="flex rounded-lg bg-gray-100 p-1" role="radiogroup" aria-label="Network selection">
                <button
                  type="button"
            ...
            {error && (
              <div className="mt-4 rounded-lg bg-red-50 p-3 text-sm text-red-700" role="alert" aria-live="assertive">
                {error}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              <div>
                <label htmlFor="reg-org-name" className="block text-sm font-medium text-gray-700">
