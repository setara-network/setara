...
export const metadata: Metadata = {
  title: "Run a Validator Node — Docker Setup Guide | Setara Network",
  description:
    "Deploy a Setara Proof-of-Authority validator node using Docker Compose. Includes IPFS, chain binary, API server. Minimum: 2 CPU, 4GB RAM, 100GB SSD. Step-by-step with port configuration.",
  keywords: ["Setara validator node", "blockchain node setup", "Docker validator", "Cosmos SDK node"],
  alternates: { canonical: "/docs/run-node" },
  openGraph: {
    title: "Run a Validator Node | Setara Network",
    description: "Deploy a Setara validator node via Docker Compose in minutes.",
    url: "/docs/run-node",
  },
};
