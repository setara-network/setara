...
export const metadata: Metadata = {
  title: "Build an App — Integration Guide | Setara Network",
  description:
    "Step-by-step guide to integrating Setara blockchain document verification into Node.js, Python, or Go applications. Register documents, upload to IPFS, and verify on-chain in 4 steps.",
  keywords: ["blockchain integration guide", "document verification tutorial", "Setara SDK", "blockchain Node.js Python Go"],
  alternates: { canonical: "/docs/build-app" },
  openGraph: {
    title: "Build an App — Integration Guide | Setara Network",
    description: "Integrate blockchain document verification in 4 steps with code examples in Node.js, Python, and Go.",
    url: "/docs/build-app",
  },
};
...
# macOS:
HASH=$(shasum -a 256 certificate.pdf | cut -d' ' -f1)
