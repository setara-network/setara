...
export const metadata: Metadata = {
  title: "REST API Reference — Document Verification API | Setara Network",
  description:
    "Complete REST API reference for Setara blockchain document verification. Register documents, verify hashes, manage wallets, and administer organizations. Includes request/response examples.",
  keywords: ["blockchain API", "document verification API", "REST API blockchain", "Setara API reference"],
  alternates: { canonical: "/docs/api" },
  openGraph: {
    title: "REST API Reference | Setara Network",
    description: "Register documents, verify hashes, and manage wallets via the Setara REST API.",
    url: "/docs/api",
  },
};
